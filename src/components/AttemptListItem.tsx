    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div
            className={`flex items-center justify-center w-10 h-10 rounded-full ${attempt.type === 'flashcard' ? 'bg-primary-100 dark:bg-primary-900 text-primary-600 dark:text-primary-400' : 'bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400'} font-semibold`}
          >
            #{totalCount - index}
          </div>
          <div>
