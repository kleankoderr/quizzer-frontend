...
export const QuestionRenderer: React.FC<QuestionRendererProps> = ({
  ...
  const renderMultiSelect = () => {
    ...
    const getCheckboxClasses = (
      ...
      const baseClass =
        'flex-shrink-0 w-6 h-6 rounded border-2 flex items-center justify-center text-sm transition-colors mt-0.5';
  ...
  const renderMatching = () => {
    ...
    const getLeftItemBadgeClasses = (
      ...
      const baseClass =
        'flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm mt-0.5';
            ...
            {leftItems.map((leftItem, index) => {
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={getLeftItemBadgeClasses(
                        isCorrect,
                        isWrong,
                        isSelected,
                        !!userMatch
