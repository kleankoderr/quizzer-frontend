    ...
    const verify = async () => {
      ...
      while (attempt < maxRetries && mounted) {
        try {
          ...
          console.error(
            `Payment verification attempt ${attempt + 1} failed:`,
            error
          );
          ...
          if (error.response?.status === 409 && attempt < maxRetries - 1) {
            ...
            if (mounted) {
              setMessage(
                `Payment verification in progress... (Attempt ${attempt + 1}/${maxRetries})`
              );
            }
          ...
          {status === 'success' ? (
            ...
            <div className="flex flex-col items-center animate-in fade-in zoom-in duration-300">
              ...
              <div className="space-y-3 w-full">
                ...
                <button
                  onClick={() =>
                    window.open('mailto:support@quizzer.com', '_blank')
                  }
