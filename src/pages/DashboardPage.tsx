          ...
          <div className="flex items-center gap-3">
            <div
              className={`p-2 rounded-lg ${
                dueReviewsData.overdueCount > 0 ? 'bg-red-600' : 'bg-orange-600'
              }`}
            >
            ...
            <div className="text-left">
              ...
              >
                {dueReviewsData.totalDue} Item
                {dueReviewsData.totalDue === 1 ? '' : 's'} Due for Review
                {dueReviewsData.overdueCount > 0 && (
                  <span className="ml-2 text-sm">
                    • {dueReviewsData.overdueCount} Overdue
                  </span>
                )}
              </p>
              <p
                  ...
                  >
                    ...
                    {attempt.score !== undefined && attempt.totalQuestions && (
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        >
                          {Math.round(
                            (attempt.score / (attempt.totalQuestions || 1)) *
                              100
                          )}
                          %
                        </span>
